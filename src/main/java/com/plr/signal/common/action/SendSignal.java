...
import com.plr.signal.common.network.SendEnergyConsume;
        ...
        switch(playerIn.getPersistentData().getInt("channel")){
            case 0:
                if(itemstack.getOrCreateTag().getInt("currentpower")>=20000){
                    ...
                    if(worldIn.isClientSide){
                        Networking.INSTANCE.sendToServer(new SendEnergyConsume(20000));
                    }
            ...
            case 1:
                if(itemstack.getOrCreateTag().getInt("currentpower")>=60000){
                    ...
                    if(worldIn.isClientSide){
                        Networking.INSTANCE.sendToServer(new SendEnergyConsume(60000));
                    }
            ...
            case 2:
                if(itemstack.getOrCreateTag().getInt("currentpower")>=90000) {
                    ...
                    if(worldIn.isClientSide){
                        Networking.INSTANCE.sendToServer(new SendEnergyConsume(90000));
                    }
